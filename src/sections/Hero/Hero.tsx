import { useEffect, useState, useRef, useCallback, lazy, Suspense, type RefObject } from 'react';
...
function Hero() {
  ...
  const onMagneticMove = useCallback((e: React.MouseEvent, ref: RefObject<HTMLElement | null>) => {
  ...
  const onMagneticLeave = useCallback((ref: RefObject<HTMLElement | null>) => {

...
const PROJECTS = [
	{
		...
		description:
			'Premium automotive detailing landing page with service showcase, gallery, and contact form. Dark gold design built for conversion.',
	...
	},
	{
		...
		title: 'FormaFit Gym',
		description:
			'Fitness gym website featuring training programs, trainer profiles, client testimonials, and subscription pricing plans.',
	...
	},
	{
		...
		title: 'SwiftRate',
		description:
			'Real-time currency converter supporting lots of currencies with live exchange rates, instant conversion, and clean and modern purple UI.',
	...
	},
	{
		...
		description: (
			<>
				Full-featured task manager with active/completed task views, deadlines, pomodoro times and user authentication
				built with React and Fastify in collaboration with{' '}
	...
	},
	{
		...
		description:
			'Flashcard-style web dev theory trainer. Browse Q&A cards with markdown-rendered answers, syntax-highlighted code snippets, dark/light theme, and auth-protected question management backed by a local REST API.',
	...
	return (
		<section id='projects' ref={sectionRef} className={`${styles.projects} ${visible ? styles.visible : ''}`}>
			<header className={styles.header}>
				...
				<p className={styles.desc}>Here are some of my recent projects showcasing my skills in web development</p>
			</header>
